...
namespace Microsoft.Azure.SpatialAnchors.Unity.Examples
{
    public abstract class DemoScriptBase : InputInteractionBase
    {
        ...
        public abstract Task CreateAnchorAsync();
        ...
        public async void CreateAnchor()
        {
            try
            {
                advanceDemoTask = CreateAnchorAsync();
                await advanceDemoTask;
            }
            catch (Exception ex)
            {
                Debug.LogError($"{nameof(DemoScriptBase)} - Error in {nameof(CreateAnchor)}: {ex.Message} {ex.StackTrace}");
                feedbackBox.text = $"Demo failed, check debugger output for more information";
            }
        }
        ...
        public abstract Task CreateAnchorAsync();
        public abstract Task LockAnchorAsync();
        public abstract Task SaveAnchorAsync();
        public abstract Task StartWatcherAsync();
        public abstract Task DeleteAnchorAsync();
        public abstract Task DeleteAllAnchorsAsync();
        ...
        public async void LockAnchor()
        {
            try
            {
                advanceDemoTask = LockAnchorAsync();
                await advanceDemoTask;
            }
            catch (Exception ex)
            {
                Debug.LogError($"{nameof(DemoScriptBase)} - Error in {nameof(LockAnchor)}: {ex.Message} {ex.StackTrace}");
            }
        }
        ...
        public async void SaveAnchor()
        {
            try
            {
                advanceDemoTask = SaveAnchorAsync();
                await advanceDemoTask;
            }
            catch (Exception ex)
            {
                Debug.LogError($"{nameof(DemoScriptBase)} - Error in {nameof(SaveAnchor)}: {ex.Message} {ex.StackTrace}");
            }
        }
        public async void StartWatcher()
        {
            ...
            try
            {
                advanceDemoTask = StartWatcherAsync();
                await advanceDemoTask;
            }
            catch (Exception ex)
            {
                Debug.LogError($"{nameof(DemoScriptBase)} - Error in {nameof(StartWatcher)}: {ex.Message} {ex.StackTrace}");
            }
        }
        ...
        public async void DeleteAnchor()
        {
            try
            {
                advanceDemoTask = DeleteAnchorAsync();
                await advanceDemoTask;
            }
            catch (Exception ex)
            {
                Debug.LogError($"{nameof(DemoScriptBase)} - Error in {nameof(DeleteAnchor)}: {ex.Message} {ex.StackTrace}");
            }
        ...
        public async void DeleteAllAnchors()
        {
            try
            {
                advanceDemoTask = DeleteAllAnchorsAsync();
                await advanceDemoTask;
            }
            catch (Exception ex)
            {
                Debug.LogError($"{nameof(DemoScriptBase)} - Error in {nameof(DeleteAllAnchors)}: {ex.Message} {ex.StackTrace}");
            }
        }
