...
public class AnchorCreationFragment extends Fragment {
    ...
    private void onCreateAnchorClicked(View view) {
        ...
        cloudAnchor.getAppProperties().put("ComponentType", placedVisual.getComponentType().toString());
        ...
        if(messageET.getText().toString()!=null && !messageET.getText().toString().equals("")){
            cloudAnchor.getAppProperties().put("Message", messageET.getText().toString());
        }
        else{
            cloudAnchor.getAppProperties().put("Message", "No message ");
        }
